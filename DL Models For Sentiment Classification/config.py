...
def args_initialization():
    ...
    parser.add_argument("-multilabel", type=bool, default=True, help="是否为多标签分类任务 [默认: True]")
    ...
    parser.add_argument("-filter-sizes", type=str, default="1,3,5",
    ...
    parser.add_argument("-ernie-pretrained", type=str,
                        default="../../model/ernie_pretrained", help="ERNIE预训练模型位置")
